...
namespace PizzaShop.Data
{
    public class DbInitializer
    {
            ...
            UserManager<ApplicationUser> userManager, RoleManager<IdentityRole> roleManager)
        {
            ...
            var studentUserResult = await userManager.CreateAsync(studentUser, "Pa$$w0rd");
            ...
            var teacherUserResult = await userManager.CreateAsync(teacherUser, "Pa$$w0rd");
            ...
            //{
            context.Dishes.Add(new Dish {DishName = "Margherita", Price = 89});
            context.SaveChanges();
                ...
                //{
                //    Dish = margherita, Order = firstOrder, IsModified = true, Price = margherita.Price, CartItemName = margherita.DishName
                //};
                ...
                //var contextResult = await context.SaveChangesAsync();
            //}
        }
    }
}
